...
import './TopWine3.css';
import { TopCard3 } from './TopCard3';

export class TopWine3 extends Component {
    articles = [
        {
            "Price": "$82.66",
            ...
            <div className="ZXS11">
                {this.state.articles.map((element) => {
                    return <div key={element.url}>
                        <TopCard3 title={element.title} description={element.description} imageUrl={element.urlToImage} priCe={element.Price} />
                    </div>
                })
                }
            </div >
