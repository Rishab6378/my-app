...
export class TopWine2 extends Component {
    articles = [
        {
            "Price": "$82.66",
            ...
            <div className="ZXS11">
                {this.state.articles.map((element) => {
                    return <div key={element.url}>
                        <TopCard2 title={element.title} description={element.description} imageUrl={element.urlToImage} priCe={element.Price} />
                    </div>
                })
                }
            </div >
