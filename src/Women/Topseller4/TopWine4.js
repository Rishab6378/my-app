...
import './TopWine4.css';
import TopCard4 from './TopCard4';

export class TopWine4 extends Component {
    articles = [
        {
            "Price": "$82.66",
            ...
            <div className="ZXS11">
                {this.state.articles.map((element) => {
                    return <div key={element.url}>
                        <TopCard4 title={element.title} description={element.description} imageUrl={element.urlToImage} priCe={element.Price} />
                    </div>
                })
                }
            </div >
