        ...
        return (
            <>
                ...
                <section className="T1">
                    <div className="T2">
                        <div className="T3">
                            <span className='span'> Latest</span> <br />
                            OBSESSION
                        </div>
                    </div>
                </section>
                ...
                <section className="T4">
                    <div className="T5">
                        <div className="T6">
                            <div className="T7">ALL YOUR FAVOURITES</div>
                            <div className="T8">Anything but Basic.</div>
                            <div className="T9">Good Taste is your call. it's something you wear proudly and pour boldly. it's your
                                own personal flavour. And it looks amazing. </div>
                            <Link className="T10" to="/womenwine" target='blank'>BROWSE WINES</Link>
                        </div>
                ...
                <section className="T4">
                    <div className="T5">
                        ...
                        <div className="T14">
                            <div className="T7">BEHIND THE SCENE</div>
                            <div className="T8">The Winemaker</div>
                            <div className="T9"> From harvesting and crushing to blending and aging, Margaret Leonardi makes sure
                                every batch, every bottle, every sip of LED looks and tastes its absolute best.</div>
                            <Link className="T10" to="/womendes" target='blank'>LEARN MORE</Link>
                        </div>
                    </div>
                </section>

                {/* section  */}
                <section className="T15">
                    <div className="T16">
                        "I am to make wines that are approachable affordable, and delicious"
                    </div>
                </section>

                {/* section  */}
                <section className="T15">
                    <div className="T17">Top Seller</div>
                </section>
                ...
                <div className="bg-white">
                    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                        ...
                        <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                            <Link to="/topwine1" target='blank' className="group">
                                <div
                                    className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                                    <img src="https://images.contentstack.io/v3/assets/bltbb619fd5c667ba2d/blt0fd94f037268f852/60b12ecd1df7ea69b75bce18/7ELEVEN-ClosduBoisChardonnay.png"
                                        alt="7ELEVEN-ClosduBoisChardonnay"
                                        className="h-full w-full object-cover object-center group-hover:opacity-75" />
                                </div>
                                <h3 className="mt-4 text-sm text-gray-700">Chardonnay</h3>
                                <p className="mt-1 text-lg font-medium text-gray-900">$80.80</p>
                            </Link>
                            <Link to="/topwine2" target='blank' className="group">
                                <div
                                    className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                                    <img src="https://www.lositoeguarini.it/wp-content/uploads/2020/02/pinot-noir-vigner.png"
                                        alt="pinot-noir-vigner"
                                        className="h-full w-full object-cover object-center group-hover:opacity-75" />
                                </div>
                                <h3 className="mt-4 text-sm text-gray-700">Pinot Noir</h3>
                                <p className="mt-1 text-lg font-medium text-gray-900">$39.99</p>
                            </Link>
                            <Link to="/topwine3" target='blank' className="group">
                                <div
                                    className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                                    <img src="https://www.heartlandwines.com.au/wp-content/uploads/2018/12/cabernet-sauvignon.png"
                                        alt="cabernet-sauvignon"
                                        className="h-full w-full object-cover object-center group-hover:opacity-75" />
                                </div>
                                <h3 className="mt-4 text-sm text-gray-700">cabernet sauvignon</h3>
                                <p className="mt-1 text-lg font-medium text-gray-900">$150.99</p>
                            </Link>
                            <Link to="/topwine4" target='blank' className="group">
                                <div
                                    className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                                    <img src="https://centra.ie/thumbnail/800x800/var/files/products/Alcohol/Gallo-Family-Vineyards-Pinot-Grigio-750ml.png"
                                        alt="Gallo-Family-Vineyards-Pinot-Grigio"
                                        className="h-full w-full object-cover object-center group-hover:opacity-75" />
                                </div>
                                <h3 className="mt-4 text-sm text-gray-700">Gallo Family Pinot Grigio</h3>
                                <p className="mt-1 text-lg font-medium text-gray-900">$16.99</p>
                            </Link>
                        </div>
                    </div>
                </div>
