                    ...
                    <div className="flex min-h-full items-stretch justify-center text-center md:items-center md:px-2 lg:px-4">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button onClick={previousBtn} type="button"
                                    ...
                                    <div className="sm:col-span-8 lg:col-span-7">
                                        ...
                                        <section aria-labelledby="options-heading" className="mt-10">
                                            ...
                                            <form>
                                                        ...
                                                        <div className="grid grid-cols-4 gap-4">
                                                            ...
                                                            <label
                                                                ...
                                                                <input type="radio" name="size-choice" value="XS"
                                                                    className="sr-only" aria-labelledby="size-choice-1-label" />
                                                            ...
                                                            <label
                                                                ...
                                                                <input type="radio" name="size-choice" value="XL"
                                                                    className="sr-only" aria-labelledby="size-choice-5-label" />
                                                            ...
                                                            <label
                                                                ...
                                                                <input type="radio" name="size-choice" value="XXL"
                                                                    className="sr-only" aria-labelledby="size-choice-6-label" />
                                                            ...
                                                            <label
                                                                ...
                                                                <input type="radio" name="size-choice" value="XXXL" disabled
                                                                    className="sr-only" aria-labelledby="size-choice-7-label" />
                                                ...
                                                <Link type="submit" to="/addriesling" target='blank'
                                                    className="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Add
                                                    to bag</Link>
                                            </form>
                                        </section>
                                    </div>
...
export default RieslingAddToCart
