...
export class WhiteWine extends Component {
    articles = [
        {
            "Price": "$82.66",
            "title": "Sparkling Wine Tasmania",
            "description": " Elegant, cool-climate bubbly, celebrated for quality...",
            "urlToImage": "https://vintnersresort.com/wp-content/uploads/2023/04/JA-Blog-Post-Page.png"
        },
        {
            "Price": "$52",
            "title": "Drew MW's Cuvée",
            "description": "Barbara Drew MW's expert thoughts on Prestige Cuvée Champagne...",
            "urlToImage": "https://images7.alphacoders.com/571/thumb-1920-571431.jpg"
        },
        {
            "Price": "$39.95",
            ...
            <div className="ZXS11">
                {this.state.articles.map((element) => {
                    return <div key={element.url}>
                        <WhiteCard title={element.title} description={element.description} imageUrl={element.urlToImage} priCe={element.Price} />
                    </div>
                })}
            </div>
        )
